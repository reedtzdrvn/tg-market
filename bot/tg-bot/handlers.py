...
async def start_handler(msg: Message):
    await msg.answer(
        "Привет! Чтоб получить доступ к веб приложению необходимо поделиться номером телефона, чтобы зарегистрироваться.",
                ...
                inline_keyboard=[
                    [
                        InlineKeyboardButton(
                            text="Open Webview",
                            web_app=WebAppInfo(
                                url="https://aquamarine-dasik-75f62c.netlify.app" #и тут 
                            ),
                        )
                    ]
                ]
